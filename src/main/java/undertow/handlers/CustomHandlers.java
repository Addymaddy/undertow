...
import undertow.handlers.accesslog.Slf4jAccessLogReceiver;
...
public class CustomHandlers {
  ...
  /*  public static void health(HttpServerExchange exchange) {
    ...
    public static HttpHandler securityHeaders(HttpHandler next, ReferrerPolicyHandlers.ReferrerPolicy policy) {
